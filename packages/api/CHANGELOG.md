...
## [5.0.0](https://github.com/mikeyhodl/nft.storage/compare/api-v4.10.0...api-v5.0.0) (2025-07-15)


### ⚠ BREAKING CHANGES

* rate-limit ucan auth requests ([#2097](https://github.com/mikeyhodl/nft.storage/issues/2097))
* rate limiting by ucan agent did ([#2093](https://github.com/mikeyhodl/nft.storage/issues/2093))
...
* added script to generate ucan for w3up space and docs for how to access the space using console.web3.storage ([#2554](https://github.com/mikeyhodl/nft.storage/issues/2554)) ([ad33faf](https://github.com/mikeyhodl/nft.storage/commit/ad33faf83ae1c994f040f6ad1539496b16ad264a))
...
* **api:** add count to list nfts api ([#2701](https://github.com/mikeyhodl/nft.storage/issues/2701)) ([6da5098](https://github.com/mikeyhodl/nft.storage/commit/6da50981999241660b4b9cd58fd66b16d095ebbe))
* **api:** add create aspect to maintainence ([#2708](https://github.com/mikeyhodl/nft.storage/issues/2708)) ([ec91ae7](https://github.com/mikeyhodl/nft.storage/commit/ec91ae7ea463a1c3c50b6feaf770a27b6640f1f5))
...
* lock w3up uploads feature switch open ([#2556](https://github.com/mikeyhodl/nft.storage/issues/2556)) ([6eeefeb](https://github.com/mikeyhodl/nft.storage/commit/6eeefebe8a54f4db9e4826cba4a0847ae8ec2d14))
* NFT.storage changes ([#2560](https://github.com/mikeyhodl/nft.storage/issues/2560)) ([1903214](https://github.com/mikeyhodl/nft.storage/commit/19032140691806e07cf3b013e2afaeb01d6d8459))
...
* POST /uploads can write uploads to w3up for web3 serving and dagcargoless filecoin deal-making ([#2522](https://github.com/mikeyhodl/nft.storage/issues/2522)) ([0c77cb3](https://github.com/mikeyhodl/nft.storage/commit/0c77cb3646586b1a802e8c8ca2e8c54d0a006f56))
* put to r2 and check linkdex-api for dag structure ([#2204](https://github.com/mikeyhodl/nft.storage/issues/2204)) ([197e11b](https://github.com/mikeyhodl/nft.storage/commit/197e11b3513ef564ffcefc9db56ede812df47769))
...
* send `delegates` on pin add response ([#2351](https://github.com/mikeyhodl/nft.storage/issues/2351)) ([f4fdbba](https://github.com/mikeyhodl/nft.storage/commit/f4fdbba9e5c7fd8bac009088132c239c5ea20655))
* show deal info from w3up ([#2573](https://github.com/mikeyhodl/nft.storage/issues/2573)) ([766a7c1](https://github.com/mikeyhodl/nft.storage/commit/766a7c1dbde4e0efec8424048767f3c9e947a2ab))
...
* uploadCarWithStat avoids copying stat.carBytes via Blob construction ([#2543](https://github.com/mikeyhodl/nft.storage/issues/2543)) ([bcb67a3](https://github.com/mikeyhodl/nft.storage/commit/bcb67a3be8a704b586b35099e3e88c1fdb1c0af6))
* use 🛻 pickup from api ([#2310](https://github.com/mikeyhodl/nft.storage/issues/2310)) ([e327bb3](https://github.com/mikeyhodl/nft.storage/commit/e327bb38247401bee5b7bc3ff4a8cdbbc31e1a69))
* write DUDEWHERE link and SATNAV car indexes. ([#2238](https://github.com/mikeyhodl/nft.storage/issues/2238)) ([1951abb](https://github.com/mikeyhodl/nft.storage/commit/1951abb68bf4fd87e0a77c89409f789b8dd1b3bc))
...
* add a fake piece hasher to try to fix staging upload issues ([#2542](https://github.com/mikeyhodl/nft.storage/issues/2542)) ([542983c](https://github.com/mikeyhodl/nft.storage/commit/542983c4c42c8a78602f6025e61a5ec7750206bd))
* add backup url parts to list ([#2675](https://github.com/mikeyhodl/nft.storage/issues/2675)) ([c1cd467](https://github.com/mikeyhodl/nft.storage/commit/c1cd467315b3cdeab7a297ebb1d5023494052f18))
...
* allow count header ([13c229b](https://github.com/mikeyhodl/nft.storage/commit/13c229bb960e851074fa8d1da19c4f3ec481cbf6))
* allow zero count ([09dea5b](https://github.com/mikeyhodl/nft.storage/commit/09dea5b67d67b49e220c35258ba5d14efbc5ffe5))
...
* avoid car repack ([#2551](https://github.com/mikeyhodl/nft.storage/issues/2551)) ([b0d622e](https://github.com/mikeyhodl/nft.storage/commit/b0d622eb473d57de86b4cc917a006320da33b626))
* avoid car repack ([#2552](https://github.com/mikeyhodl/nft.storage/issues/2552)) ([b4ff571](https://github.com/mikeyhodl/nft.storage/commit/b4ff5719a5031c51cffa80803e946300d4af131c))
...
* change to post method ([#2547](https://github.com/mikeyhodl/nft.storage/issues/2547)) ([65e20fb](https://github.com/mikeyhodl/nft.storage/commit/65e20fbdaa1dc3e33235b5cc9671bd61e6a4404c))
...
* deleted token error message ([#2378](https://github.com/mikeyhodl/nft.storage/issues/2378)) ([10f6d7b](https://github.com/mikeyhodl/nft.storage/commit/10f6d7b6aba517a8bd7faa5330af9ae127fa73d5))
* dudewhere root cid should be content cid ([#2392](https://github.com/mikeyhodl/nft.storage/issues/2392)) ([e1bcf5e](https://github.com/mikeyhodl/nft.storage/commit/e1bcf5e12c22ff6226732e16a4b926e8d6bb8311))
...
* enable `url_standard` compatbility flag ([#2540](https://github.com/mikeyhodl/nft.storage/issues/2540)) ([bdde10a](https://github.com/mikeyhodl/nft.storage/commit/bdde10a1aff8e59a371a04b5ac5315e0e072bff8))
* enable the `url_standard` compatibility flag ([#2537](https://github.com/mikeyhodl/nft.storage/issues/2537)) ([e822bab](https://github.com/mikeyhodl/nft.storage/commit/e822bab9dddccd91386032f2eeb274a51dcb02a5))
* enabled nodejs compat ([#2545](https://github.com/mikeyhodl/nft.storage/issues/2545)) ([654cde7](https://github.com/mikeyhodl/nft.storage/commit/654cde7ef93a195a74359d015e0c8030abdeae3f))
* expose count header ([f9468d2](https://github.com/mikeyhodl/nft.storage/commit/f9468d2a57c7d1e0042ed0ce8279c18e39a023af))
...
* include R2 key in error message ([#2326](https://github.com/mikeyhodl/nft.storage/issues/2326)) ([b8d0f98](https://github.com/mikeyhodl/nft.storage/commit/b8d0f98821f34186cccfdf9c7e9ec7e1c79f6e7a))
...
* log out proof ([225cf28](https://github.com/mikeyhodl/nft.storage/commit/225cf286bf28b497dcfd67bd9e566e26a19d1edb))
* log proof for debugging ([#2535](https://github.com/mikeyhodl/nft.storage/issues/2535)) ([0ecace3](https://github.com/mikeyhodl/nft.storage/commit/0ecace3ed41c7330ccf84691b70cf33e17669d52))
...
* more logging ([#2536](https://github.com/mikeyhodl/nft.storage/issues/2536)) ([11ae646](https://github.com/mikeyhodl/nft.storage/commit/11ae64679bb505ecd08c46f62598d0318d81f059))
* more logging of upload get fail ([#2593](https://github.com/mikeyhodl/nft.storage/issues/2593)) ([35cc344](https://github.com/mikeyhodl/nft.storage/commit/35cc34499125ac24292fdfbb61d67569f279f089))
* one more typo ([de5582e](https://github.com/mikeyhodl/nft.storage/commit/de5582eac5cb739bc48294a3a0ff95422d8a20e6))
...
* remove debugging console.logs and nodejs_compat flag ([#2553](https://github.com/mikeyhodl/nft.storage/issues/2553)) ([6ceb299](https://github.com/mikeyhodl/nft.storage/commit/6ceb299627085e9cfac3a5c216d8fd4d3a6c8d33))
...
* Revert "fix: try older w3up client" ([#2549](https://github.com/mikeyhodl/nft.storage/issues/2549)) ([b31847b](https://github.com/mikeyhodl/nft.storage/commit/b31847babc3c6a37b4bcf4d865117a8e247f826e))
* revert debugging prs ([#2539](https://github.com/mikeyhodl/nft.storage/issues/2539)) ([ba22d01](https://github.com/mikeyhodl/nft.storage/commit/ba22d01d36bf75f8e676b2d5b90bd3ae9383ed07))
...
* specify zone_id for production deployment ([dd6a626](https://github.com/mikeyhodl/nft.storage/commit/dd6a6267174db1be8ac6711d7c1b686ec602d47d))
* specify zone_id for staging deployment ([1687f8d](https://github.com/mikeyhodl/nft.storage/commit/1687f8d4fd1cd29f9c9616399fea7553d0048577))
...
* this param for fetch calls ([#2428](https://github.com/mikeyhodl/nft.storage/issues/2428)) ([ed04997](https://github.com/mikeyhodl/nft.storage/commit/ed04997790278a28f927a6517387bc323f914ac2))
* try older w3up client ([#2548](https://github.com/mikeyhodl/nft.storage/issues/2548)) ([5d94ec5](https://github.com/mikeyhodl/nft.storage/commit/5d94ec579a2521391b52d6e989e103379486ba6b))
...
* update toucan-js to report error cause ([#2234](https://github.com/mikeyhodl/nft.storage/issues/2234)) ([34930d6](https://github.com/mikeyhodl/nft.storage/commit/34930d631de3d8e9b43bb9902ef882bfc7bf7b2f))
* upgrade @ipld/dag-cbor ([#2534](https://github.com/mikeyhodl/nft.storage/issues/2534)) ([964a12c](https://github.com/mikeyhodl/nft.storage/commit/964a12cd0239320077a0ae61818f4c78f1775585))
...
* verify CAR blocks with all supported hashes ([#2460](https://github.com/mikeyhodl/nft.storage/issues/2460)) ([4526369](https://github.com/mikeyhodl/nft.storage/commit/45263692713e6173d7cdec1a69df8a284e5e293a))
...
* add a bunch of console.logs ([#2544](https://github.com/mikeyhodl/nft.storage/issues/2544)) ([2fc34f3](https://github.com/mikeyhodl/nft.storage/commit/2fc34f38550cbb8a9541e067b2bec17d9f50bedb))
...
* api Logging#setUser expects user.id as string instead of number ([#2233](https://github.com/mikeyhodl/nft.storage/issues/2233)) ([109462f](https://github.com/mikeyhodl/nft.storage/commit/109462f6f2e229d9de9808379c82189b14430eb3))
...
* expose simple route to debug ([#2546](https://github.com/mikeyhodl/nft.storage/issues/2546)) ([8a9aef5](https://github.com/mikeyhodl/nft.storage/commit/8a9aef57776966b2e39b176684f57c09daea7019))
...
* **main:** release api 4.1.0 ([#2161](https://github.com/mikeyhodl/nft.storage/issues/2161)) ([203f7c1](https://github.com/mikeyhodl/nft.storage/commit/203f7c18c14784b102de65501d77977971fd9f4f))
* **main:** release api 4.10.0 ([#2709](https://github.com/mikeyhodl/nft.storage/issues/2709)) ([b262a94](https://github.com/mikeyhodl/nft.storage/commit/b262a942008f299f766e0c884e2a9d762fec7d2a))
* **main:** release api 4.2.0 ([#2239](https://github.com/mikeyhodl/nft.storage/issues/2239)) ([4e36796](https://github.com/mikeyhodl/nft.storage/commit/4e367968bd3699704fa8c906d922c3d0bfcc4201))
* **main:** release api 4.2.1 ([#2327](https://github.com/mikeyhodl/nft.storage/issues/2327)) ([5fe1bf9](https://github.com/mikeyhodl/nft.storage/commit/5fe1bf972e2fece2b835399d825e25c5d8e1bb45))
* **main:** release api 4.3.0 ([#2350](https://github.com/mikeyhodl/nft.storage/issues/2350)) ([0d57ea3](https://github.com/mikeyhodl/nft.storage/commit/0d57ea3b215dc934c2c3bbc78d51fc0faba9944b))
* **main:** release api 4.4.0 ([#2352](https://github.com/mikeyhodl/nft.storage/issues/2352)) ([67bf44a](https://github.com/mikeyhodl/nft.storage/commit/67bf44a385ca83a044f662beb301d4684232f9c4))
* **main:** release api 4.4.1 ([#2380](https://github.com/mikeyhodl/nft.storage/issues/2380)) ([819ea1e](https://github.com/mikeyhodl/nft.storage/commit/819ea1e015ef4ef61e7e50c84ffdd652e4444776))
* **main:** release api 4.4.2 ([#2394](https://github.com/mikeyhodl/nft.storage/issues/2394)) ([a9e0a24](https://github.com/mikeyhodl/nft.storage/commit/a9e0a24100775c6f93b944b4907b5ffdf5b63265))
* **main:** release api 4.4.3 ([#2430](https://github.com/mikeyhodl/nft.storage/issues/2430)) ([4c90608](https://github.com/mikeyhodl/nft.storage/commit/4c9060839c2d0bedb69422078cb07e7accb345ab))
* **main:** release api 4.5.0 ([#2531](https://github.com/mikeyhodl/nft.storage/issues/2531)) ([10fd471](https://github.com/mikeyhodl/nft.storage/commit/10fd471053ddb4b779918ea76fc753459d250820))
* **main:** release api 4.6.0 ([#2557](https://github.com/mikeyhodl/nft.storage/issues/2557)) ([bf19e36](https://github.com/mikeyhodl/nft.storage/commit/bf19e3647d5bc125bf55ea4e6b28acdf955d55d3))
* **main:** release api 4.7.0 ([#2562](https://github.com/mikeyhodl/nft.storage/issues/2562)) ([4c78a8f](https://github.com/mikeyhodl/nft.storage/commit/4c78a8fd865960df4654bfcbad66f21811ae69bf))
* **main:** release api 4.8.0 ([#2587](https://github.com/mikeyhodl/nft.storage/issues/2587)) ([432ba59](https://github.com/mikeyhodl/nft.storage/commit/432ba5953b1c0644205830afb515097aa6e63514))
* **main:** release api 4.8.1 ([#2680](https://github.com/mikeyhodl/nft.storage/issues/2680)) ([b76ccf7](https://github.com/mikeyhodl/nft.storage/commit/b76ccf743374be1cdcd896725e313876213b9622))
* **main:** release api 4.9.0 ([#2702](https://github.com/mikeyhodl/nft.storage/issues/2702)) ([e3f7a48](https://github.com/mikeyhodl/nft.storage/commit/e3f7a482f38d685c2598744422d534edee83e42f))
* **main:** release api 4.9.1 ([#2703](https://github.com/mikeyhodl/nft.storage/issues/2703)) ([b18e322](https://github.com/mikeyhodl/nft.storage/commit/b18e322f475ada94e1bb1d2e837ee3c437c6a934))
* **main:** release api 4.9.2 ([#2705](https://github.com/mikeyhodl/nft.storage/issues/2705)) ([a140c5e](https://github.com/mikeyhodl/nft.storage/commit/a140c5e70be4f95dd60f97d08d1235e2c9b33c5a))
* **main:** release api 4.9.3 ([#2706](https://github.com/mikeyhodl/nft.storage/issues/2706)) ([83fcd72](https://github.com/mikeyhodl/nft.storage/commit/83fcd72b456b192921b94cec3c42c2cd58f61ac2))
* more deals get debugging ([#2594](https://github.com/mikeyhodl/nft.storage/issues/2594)) ([36a26f1](https://github.com/mikeyhodl/nft.storage/commit/36a26f14d7f9dfa9a204f37af7b4fc5fea1aa537))
...
* remove debugging ([#2595](https://github.com/mikeyhodl/nft.storage/issues/2595)) ([3dc7916](https://github.com/mikeyhodl/nft.storage/commit/3dc7916eb7833b5a267624e07783c05494be5f2f))
* remove legacy upload codepath ([#2580](https://github.com/mikeyhodl/nft.storage/issues/2580)) ([88c05a9](https://github.com/mikeyhodl/nft.storage/commit/88c05a90289a5c702d477723f0e4812f8e62b7f4))
...
* simple test case to check limits ([#2550](https://github.com/mikeyhodl/nft.storage/issues/2550)) ([6a50a70](https://github.com/mikeyhodl/nft.storage/commit/6a50a70a1e0639f9db8311e75677175ae40f34b4))
