...
## [3.0.0](https://github.com/mikeyhodl/nft.storage/compare/website-v2.12.0...website-v3.0.0) (2025-07-15)
...
* add plausible analytics ([#2265](https://github.com/mikeyhodl/nft.storage/issues/2265)) ([78cdc5a](https://github.com/mikeyhodl/nft.storage/commit/78cdc5a845963cc0a32d64e93b2ee77acbe2c915))
...
* tweak readme ([#2563](https://github.com/mikeyhodl/nft.storage/issues/2563)) ([6a6298a](https://github.com/mikeyhodl/nft.storage/commit/6a6298a642beda6e06940dbb739d78d466a41815))
...
* update stats page ([#2205](https://github.com/mikeyhodl/nft.storage/issues/2205)) ([bbc5a88](https://github.com/mikeyhodl/nft.storage/commit/bbc5a880f02fae45222c0a732aa4cfb5ec2ff353))
...
* **website:** update website to remove upload functionality ([#2704](https://github.com/mikeyhodl/nft.storage/issues/2704)) ([060dfd5](https://github.com/mikeyhodl/nft.storage/commit/060dfd54df7d6d8fadf856b1d90a92c1b731450d))
...
* broken link to API Keys page ([#2335](https://github.com/mikeyhodl/nft.storage/issues/2335)) ([3e89eb8](https://github.com/mikeyhodl/nft.storage/commit/3e89eb843d11cb727c33f0af809b5454c2e07be8))
...
* change domain to classic-app.nft.storage ([#2677](https://github.com/mikeyhodl/nft.storage/issues/2677)) ([d8c766c](https://github.com/mikeyhodl/nft.storage/commit/d8c766cc4fbcfa0696a84dbb4febd476e241b4a8))
* clarify docs when status is pinning ([#2343](https://github.com/mikeyhodl/nft.storage/issues/2343)) ([cee649b](https://github.com/mikeyhodl/nft.storage/commit/cee649b897d2776de0f8d411002633e47878ac15))
...
* docs with incorrect blocking duration due to rate limits ([#2231](https://github.com/mikeyhodl/nft.storage/issues/2231)) ([95d82cd](https://github.com/mikeyhodl/nft.storage/commit/95d82cd3f6208ae8f23a855c309c4569414b996c))
...
* emphasize when PSA is needed in docs ([#2312](https://github.com/mikeyhodl/nft.storage/issues/2312)) ([c8b8838](https://github.com/mikeyhodl/nft.storage/commit/c8b883891d2efa67e8d93217a233ae13d9ce1b3f))
...
* make blocking explicit in ToS ([#2435](https://github.com/mikeyhodl/nft.storage/issues/2435)) ([63e9f10](https://github.com/mikeyhodl/nft.storage/commit/63e9f10487883fa53480d78291405884addee81b))
...
* pin tailwind to version used in production ([#2528](https://github.com/mikeyhodl/nft.storage/issues/2528)) ([64239e7](https://github.com/mikeyhodl/nft.storage/commit/64239e73466d76031764bdfe9decd54e8b3ef9dc))
* PSA language emphasizing not for production ([#2322](https://github.com/mikeyhodl/nft.storage/issues/2322)) ([aaee05d](https://github.com/mikeyhodl/nft.storage/commit/aaee05d4fef6567e66ad43cf3ee661605d50f417))
...
* remove overflow issue on stats page ([#2226](https://github.com/mikeyhodl/nft.storage/issues/2226)) ([99143ec](https://github.com/mikeyhodl/nft.storage/commit/99143ece32dab34aab33fbbb2098baecf1bbb568))
...
* typo in PSA docs ([#2314](https://github.com/mikeyhodl/nft.storage/issues/2314)) ([5edb1d5](https://github.com/mikeyhodl/nft.storage/commit/5edb1d520da5839d9ab5cdf6dae65d38275574d7))
* typo in status docs ([#2253](https://github.com/mikeyhodl/nft.storage/issues/2253)) ([efcb80b](https://github.com/mikeyhodl/nft.storage/commit/efcb80b07f0077905ff9078af749765d24613a9e))
...
* update footer link to the nftstorage twitter page ([#2353](https://github.com/mikeyhodl/nft.storage/issues/2353)) ([a0934cd](https://github.com/mikeyhodl/nft.storage/commit/a0934cd0b85284807ba4e84df66c2534b5a3e3dd)), closes [#2318](https://github.com/mikeyhodl/nft.storage/issues/2318)
...
* URL to blog ([#2261](https://github.com/mikeyhodl/nft.storage/issues/2261)) ([719058e](https://github.com/mikeyhodl/nft.storage/commit/719058e5da8fa93ef5213adee3236e36731090a7))
* use cf pages token ([db63ad1](https://github.com/mikeyhodl/nft.storage/commit/db63ad1035ef30c4f7e295676aa90cbbcfcb08f2))
* use correct "nft get" endpoint ([#2589](https://github.com/mikeyhodl/nft.storage/issues/2589)) ([27632d8](https://github.com/mikeyhodl/nft.storage/commit/27632d82139399e56fc43248b07723b11ecb84dd))
* use correct API URL for classic.nft.storage ([#2558](https://github.com/mikeyhodl/nft.storage/issues/2558)) ([cca7d5b](https://github.com/mikeyhodl/nft.storage/commit/cca7d5b0413b72f2bb18ad75c88b12ce2f66c3d8))
* use dynamic title in head on docs pages ([#2319](https://github.com/mikeyhodl/nft.storage/issues/2319)) ([5d55330](https://github.com/mikeyhodl/nft.storage/commit/5d5533090ef917dacfb971c9aa42de8ac71dc342))
...
* add note about /store endpoint perf & recommend /upload ([#2218](https://github.com/mikeyhodl/nft.storage/issues/2218)) ([ce81d2a](https://github.com/mikeyhodl/nft.storage/commit/ce81d2a88eeaaa97344b909105900b63894c6d9b))
...
* delete solona guide ([#2423](https://github.com/mikeyhodl/nft.storage/issues/2423)) ([2bd182f](https://github.com/mikeyhodl/nft.storage/commit/2bd182fe02ccdb3d512546d59c485ee504705e30))
...
* **main:** release website 2.10.0 ([#2561](https://github.com/mikeyhodl/nft.storage/issues/2561)) ([2d7a5f5](https://github.com/mikeyhodl/nft.storage/commit/2d7a5f5780ee24eb1c2ca71313acfed2c6b8e73d))
* **main:** release website 2.11.0 ([#2574](https://github.com/mikeyhodl/nft.storage/issues/2574)) ([ac43e13](https://github.com/mikeyhodl/nft.storage/commit/ac43e13005c59e51ca6d27fabec8999f8d07e38f))
* **main:** release website 2.11.1 ([#2678](https://github.com/mikeyhodl/nft.storage/issues/2678)) ([1cfd36c](https://github.com/mikeyhodl/nft.storage/commit/1cfd36c870232611a474487445e0cf63f1b92bb7))
* **main:** release website 2.12.0 ([#2707](https://github.com/mikeyhodl/nft.storage/issues/2707)) ([dd6ff26](https://github.com/mikeyhodl/nft.storage/commit/dd6ff26460eecb82592ceb1c8b752844c329b859))
...
* **main:** release website 2.6.1 ([#2212](https://github.com/mikeyhodl/nft.storage/issues/2212)) ([dc9acee](https://github.com/mikeyhodl/nft.storage/commit/dc9acee1a6370ce4d39bebe204c1d7e4aa434da7))
* **main:** release website 2.7.0 ([#2223](https://github.com/mikeyhodl/nft.storage/issues/2223)) ([788a0c4](https://github.com/mikeyhodl/nft.storage/commit/788a0c4456b508c214163f876ed3a2ad449732ae))
* **main:** release website 2.7.1 ([#2227](https://github.com/mikeyhodl/nft.storage/issues/2227)) ([d85f0cd](https://github.com/mikeyhodl/nft.storage/commit/d85f0cd18341fe207dbfc87a6dd0b5dc14ef9391))
* **main:** release website 2.8.0 ([#2232](https://github.com/mikeyhodl/nft.storage/issues/2232)) ([cf43a2d](https://github.com/mikeyhodl/nft.storage/commit/cf43a2d159e697079acae3ef8c15aea9891fda69))
* **main:** release website 2.8.1 ([#2313](https://github.com/mikeyhodl/nft.storage/issues/2313)) ([bc98d17](https://github.com/mikeyhodl/nft.storage/commit/bc98d1798c812f8d47380dc3a2c54aadfc60254f))
* **main:** release website 2.8.2 ([#2315](https://github.com/mikeyhodl/nft.storage/issues/2315)) ([8ec3568](https://github.com/mikeyhodl/nft.storage/commit/8ec35682dc7d2bddaf37842117b2bc326d87613d))
* **main:** release website 2.8.3 ([#2354](https://github.com/mikeyhodl/nft.storage/issues/2354)) ([9100613](https://github.com/mikeyhodl/nft.storage/commit/91006130fb78c4dfab21412d7183f36badc01bc8))
* **main:** release website 2.8.4 ([#2379](https://github.com/mikeyhodl/nft.storage/issues/2379)) ([a22a1a5](https://github.com/mikeyhodl/nft.storage/commit/a22a1a5461f2d83b34016fb38b8cfbb094db5778))
* **main:** release website 2.8.5 ([#2429](https://github.com/mikeyhodl/nft.storage/issues/2429)) ([0e34b13](https://github.com/mikeyhodl/nft.storage/commit/0e34b13ebcb3883648b88021e5cd6037ef8bf1b6))
* **main:** release website 2.9.0 ([#2529](https://github.com/mikeyhodl/nft.storage/issues/2529)) ([fc19d97](https://github.com/mikeyhodl/nft.storage/commit/fc19d97fe8fec186ffe23529734e512fa721a76a))
